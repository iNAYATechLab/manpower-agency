...
export const IVCS = {
  ...
  format: "vMAJOR.MINOR.PATCH+BUILD",
  current: "v2.3.0" as const,
  currentRaw: "2.3.0" as const,
  phase: "Phase 14-15 (Steps 286-300)" as const,
...
export const PHASE_VERSION_MAP: Record<string, Version> = {
  ...
  "Phase 6 (Steps 101-120)": "v2.3.0",
  "Phase 7 (Steps 121-140)": "v2.3.0",
  "Phase 8 (Steps 141-160)": "v2.3.0",
